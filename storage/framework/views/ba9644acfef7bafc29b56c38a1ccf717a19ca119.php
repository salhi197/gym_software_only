...
<?php $__env->startSection('content'); ?>
                    <div class="card">
                            <div class="card-body table1">
                                    <div class="row">
                                        <form method="post" action="<?php echo e(route('inscription.filter')); ?>">                                                    
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col-md-3" >
                                        ...
                                        <tbody class="text-dark">
                                            ...
                                            ">
                                                ...
                                                <td>
                                                    ...
                                                    <?php else: ?>
                                                        <?php echo e(trans('main.non_active')); ?>
                                                ...
                                                <td>
                                                    <a class="btn bubbly-button text-white" href="<?php echo e(route('inscription.presence',['inscription'=>$inscription->id])); ?>">
                                                        ...
                                                        <?php echo e(trans('main.Présences')); ?>

                                                    </a>
                                                    <?php if(Auth::user()->isadmin == 1): ?>
                                                    <a class="btn bubbly-button text-white" href="<?php echo e(route('inscription.destroy',['inscription'=>$inscription->id])); ?>">
