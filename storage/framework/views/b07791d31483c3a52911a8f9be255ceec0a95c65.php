      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <li><a href="<?php echo e(route('decharge.index')); ?>" class="dropdown-item">Charges </a></li>
...
<!--           <li class="nav-item">
 ...
 -->
    ...
    <div class="col-md-2">
        <input class="form-control" id="input_id" placeholder="scanner :" autofocus/>
      </div>    
  </nav>
...
$(window).on("load",function(){
  ...
  $('#input_id').on('change',function(){
      ...
      if($('#input_id').val().length >0){
        ...
        if(host=="http://localshost:8000" && u!='http://localhost:8000/membre/create'){
          console.log("host")
