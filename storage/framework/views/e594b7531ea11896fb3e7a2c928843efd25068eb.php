                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" >
                                    ...
                                    <input class="form-control" value="<?php echo e($date_fin ?? ''); ?>" name="date_fin" type="date" />
                                                    ...
                                                    <div class="col-md-4" >
                                                        <label class="m-0 text-white" style="font-size:30px;">Caissier:</label><br>
               ...
               <div class="card mb-4">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th scope="row"><?php echo e(trans('main.Assurance')); ?></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <h1>
                                    <?php echo e($assurancesSolde+$beneficeLibres+$benefice-$decharges); ?> DA
                                </h1>
                            </td>
                        </tr>
                      </tbody>
