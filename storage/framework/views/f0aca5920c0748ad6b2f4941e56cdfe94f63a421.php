    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info">
                    <div class="inner">
                        <h3><?php echo e($assurancesSolde); ?></h3>
                        <p>
                            Montant
                        </p>
                    </div>
        ...
        <table id="example1" class="table table-striped table-bordered no-wrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($assurance->nom_prenom ?? 'vide '); ?> </td>
                    <td><?php echo e($assurance->telephone ?? 'vide'); ?> </td>
                    <td><?php echo e($assurance->prix ?? 'vide'); ?> </td>
