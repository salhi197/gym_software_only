            ...
            columns: [
                ...
                { data:'telephone'},
                {
                        ...
                        mRender: function (data, type, row) {
                            var view = '<a href="/membre/membre/' + row.matricule + ' " class="btn bubbly-button text-white"><?php echo e(trans("main.Profile")); ?> </a>';
                            ...
                            view += ' <a href="/membre/destroy/' + row.matricule + ' " class="btn bubbly-button text-white"><?php echo e(trans("main.Supprimer")); ?> <i class="fa fa-trash"></i></a>';
                            return view
                        },
                }
