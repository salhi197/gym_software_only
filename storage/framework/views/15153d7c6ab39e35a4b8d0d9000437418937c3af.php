  ...
  $('#input_id').on('change',function(){
      ...
      if($('#input_id').val().length >0){
          ...
          if(res==false){
            ...
            window.location.href = 'http://192.168.1.2:8000/membre/edit/'+number;
          }
      }
  });
...
var profile = 0;
        ...
        // if(host=="http://192.168.1.2:8000" && u!='http://192.168.1.2:8000/membre/create'){
        //   console.log("host")
        ...
        //                   if(str.length>0){
        //                       window.location.replace("http://192.168.1.2:8000/membre/edit/"+str);
            ...
            setInterval(function(){
                  ...
                  $.ajax({
                    ...
                    success: function (data) { 
                      ...
                      if(data.connexion==1){
                        console.log("data.connexion")
                        $('#check').html('Connecté').removeClass().addClass('badge badge-success')
                      }else{
                        console.log("data.connexion.saz")
                        $('#check').html('Non Connecté').removeClass().addClass('badge badge-danger')
                      }
                    },error:function(err){
                      $('#check').html('Connecté ,Error').removeClass().addClass('badge badge-warning')
                    }
                }); 
          },3000)
        }
