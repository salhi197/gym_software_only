                            ...
                            <div class="col-lg-12">
                                <div class="card mt-2">
                                    <div class="card-header">
                                        ...
                                        <?php echo e(trans('main.Nouveau Membre')); ?> :
                                        </h1>
                                    ...
                                    <div class="card-body table1">
                                        ...
                                        <?php echo csrf_field(); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    <h1 class="m-0 text-white"><?php echo e(trans('main.Informations Personnels')); ?>  :</h1>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Code de Matricule')); ?>:</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Numéro de la carte Nationale')); ?> :</label>
                                                        <input type="text" value="<?php echo e(old('identite')); ?>" name="identite" class="form-control">

                                                    </div>

                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.nom')); ?>:</label>
                                                        <input type="text" required value="<?php echo e(old('nom')); ?>" name="nom" class="form-control">
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Prénom')); ?>:</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Téléphone')); ?></label>
                                                        <input type="text" value="<?php echo e(old('telephone')); ?>" name="telephone" class="form-control">
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Groupe Sanguin')); ?></label><br>
                                                ...
                                                <div class ="col-sm-5 offset-md-2">
                                                    <h1 class="m-0 text-white"><?php echo e(trans('main.Informations inscriptions')); ?> :</h1>
                                                    <!-- <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Nombre de mois')); ?>:</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Date début')); ?>:</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Tarification')); ?>:</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Remise')); ?>:</label>
                                                        <input type="number" value="<?php echo e(old('remise') ?? 0); ?>" id="remise" name="remise" class="form-control">
                                                    </div>


                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Total Final')); ?> : </label>
                                                        <input type="number" value="<?php echo e(old('ttc') ?? 0); ?>" onkeydown="return false;" id="total" name="total" class="form-control">
                                                    </div>


                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Versement')); ?>:</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;"><?php echo e(trans('main.Reste')); ?>:</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 offset-md-4" style="padding:30px;">
                                                    <button style="padding:30px;font-size:30px;border-radius: 25% 10%;" type="submit" id="valider" class="btn bubbly-button btn-sm"><?php echo e(trans('main.Valider')); ?></button>
                                                </div>
                                                <div class="col-md-2" style="padding:30px;">
                                                    <a style="padding:30px;font-size:30px;border-radius: 25% 10%;" 
                                                    onclick="window.history.go(-1); return false;"
                                                     class="btn bubbly-button btn-sm"><?php echo e(trans('main.Annuler')); ?></a>
                                                </div>
                                            </div>
                                    </div>
                                </div>
